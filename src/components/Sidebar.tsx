    ...
    <aside className="w-64 bg-brand-900 min-h-screen flex flex-col">
      ...
      <div className="p-4 border-t border-brand-700">
        <button
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-brand-200 hover:bg-brand-800 hover:text-white transition-colors w-full"
        >
